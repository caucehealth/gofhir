...
func (r *Linkage) GetMeta() dt.Meta {
	if r.Meta != nil {
		return *r.Meta
	}
	var zero dt.Meta
...
func (r *Linkage) GetImplicitRules() dt.URI {
...
func (r *Linkage) GetLanguage() dt.Code {
	if r.Language != nil {
		return *r.Language
	}
	var zero dt.Code
...
func (r *Linkage) GetText() dt.Narrative {
	if r.Text != nil {
		return *r.Text
	}
...
func (r *Linkage) GetContained() []json.RawMessage {
	if r.Contained != nil {
		return r.Contained
	}
	return nil
...
func (r *Linkage) GetExtension() []dt.Extension {
	if r.Extension != nil {
		return r.Extension
	}
	return nil
...
func (r *Linkage) GetModifierExtension() []dt.Extension {
...
func (r *Linkage) GetAuthor() dt.Reference {
	if r.Author != nil {
		return *r.Author
	}
...
func (r *Linkage) GetItem() []LinkageItem {
	if r.Item != nil {
		return r.Item
	}
	return nil
...
func (r *Linkage) GetExtra() map[string]json.RawMessage {
	return r.Extra
}
